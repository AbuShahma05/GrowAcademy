...
const Home = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Features Section */}
      <section className="py-12 md:py-20 bg-gradient-to-r from-[#e2754d]">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-8 md:mb-12">
            Why Choose GrowAcademy?
          </h2>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 px-12">
      ...
      {/* Stats Section */}
      <section className="py-12 md:py-20 bg-gradient-to-r from-[#e2754d] text-black">
        <div className="container mx-auto px-4">
